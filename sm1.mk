...
PRODUCT_COPY_FILES += \
    ...
    $(LOCAL_PATH)/media/media_codecs_ext.xml:$(TARGET_COPY_OUT_VENDOR)/etc/media_codecs_ext.xml \
...
$(call inherit-product, vendor/amlogic/sm1-common/sm1-common-vendor.mk)
